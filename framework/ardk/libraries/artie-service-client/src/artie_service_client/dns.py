...
ARTIE_SERVICE_BROKER_HOSTNAME = os.getenv(constants.ArtieEnvVariables.ARTIE_SERVICE_BROKER_HOSTNAME, "localhost")
ARTIE_SERVICE_BROKER_PORT = int(os.getenv(constants.ArtieEnvVariables.ARTIE_SERVICE_BROKER_PORT, 18864))
...
_registry_client = TCPRegistryClient(ARTIE_SERVICE_BROKER_HOSTNAME, ARTIE_SERVICE_BROKER_PORT)

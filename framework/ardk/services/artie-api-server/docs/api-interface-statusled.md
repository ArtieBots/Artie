...
This API reference is for the general status LED interface (see [interfaces/status_led.py](../../../libraries/artie-service-client/src/artie_service_client/interfaces/status_led.py)).

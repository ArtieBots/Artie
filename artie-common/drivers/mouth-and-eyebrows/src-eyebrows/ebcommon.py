...
MCU_ADDRESS_MAP = {
    "eyebrow-left": board.I2C_ADDRESS_EYEBROWS_MCU_LEFT,
    "eyebrow-right": board.I2C_ADDRESS_EYEBROWS_MCU_RIGHT,
}
...
def get_address(side: str):
    ...
    if address is None:
        errmsg = f"Given side: '{side}', but must be 'eyebrow-left' or 'eyebrow-right'."
        alog.error(errmsg)
